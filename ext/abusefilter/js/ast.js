...
Torus.classes.AFAST.Node = function(token, type) {
	if(!(this instanceof Torus.classes.AFAST.Node)) {
		throw new Error('Torus.classes.AFAST.Node must be called with `new`.');
	}
	this.type = type;
...
Torus.classes.AFAST.Filter = function() {
	if(!(this instanceof Torus.classes.AFAST.Filter)) {
		throw new Error('Torus.classes.AFAST.Filter must be called with `new`.');
	}
	this.type = 'filter';
	this.full_text = '';
	this.statements = [];
...
Torus.classes.AFAST.Assignment = function(token) {
	if(!(this instanceof Torus.classes.AFAST.Assignment)) {
		throw new Error('Torus.classes.AFAST.Assignment must be called with `new`.');
	}
...
Torus.classes.AFAST.Unary = function(token) {
	if(!(this instanceof Torus.classes.AFAST.Unary)) {
		throw new Error('Torus.classes.AFAST.Unary must be called with `new`.');
	}
...
Torus.classes.AFAST.Math = function(token) {
	if(!(this instanceof Torus.classes.AFAST.Math)) {
		throw new Error('Torus.classes.AFAST.Math must be called with `new`.');
	}
...
Torus.classes.AFAST.Comparison = function(token) {
	if(!(this instanceof Torus.classes.AFAST.Comparison)) {
		throw new Error('Torus.classes.AFAST.Comparison must be called with `new`.');
	}
...
Torus.classes.AFAST.Call = function(token) {
	if(!(this instanceof Torus.classes.AFAST.Call)) {
		throw new Error('Torus.classes.AFAST.Call must be called with `new`.');
	}
...
Torus.classes.AFAST.Constant = function(token) {
	if(!(this instanceof Torus.classes.AFAST.Constant)) {
		throw new Error('Torus.classes.AFAST.Constant must be called with `new`.');
	}
...
Torus.classes.AFAST.Variable = function(token) {
	if(!(this instanceof Torus.classes.AFAST.Variable)) {
		throw new Error('Torus.classes.AFAST.Variable must be called with `new`.');
	}
