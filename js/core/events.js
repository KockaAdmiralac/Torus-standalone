Torus.classes.Event = function(type, event, room) { // this is really just so you can this instanceof Torus.classes.Event
	if(!(this instanceof Torus.classes.Event)) {
		throw new Error('Must call Torus.classes.Event with `new`.');
	}
...
Torus.classes.WindowEvent = function(event) {
	if(!(this instanceof Torus.classes.WindowEvent)) {
		throw new Error('Must call Torus.classes.WindowEvent with `new`.');
	}
...
Torus.classes.ChatEvent = function(event, room) {
	if(!(this instanceof Torus.classes.ChatEvent)) {
		throw new Error('Must call Torus.classes.ChatEvent with `new`.');
	}
...
Torus.classes.IOEvent = function(event, room) {
	if(!(this instanceof Torus.classes.IOEvent)) {
		throw new Error('Must call Torus.classes.IOEvent with `new`.');
	}
